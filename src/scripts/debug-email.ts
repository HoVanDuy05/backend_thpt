...
async function debugEmail() {
  ...
  if (fromEmail.includes('resend.dev')) {
    console.warn(
      '⚠️  WARNING: You are using the default Resend Sandbox domain (onboarding@resend.dev).',
    );
    console.warn(
      '   In this mode, you can ONLY send emails to the address you used to sign up for Resend.',
    );
